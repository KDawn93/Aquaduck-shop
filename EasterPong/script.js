...
var colors = ['#FBF968', '#2AE92A', '#AF34DC', '#8c52ff', '#9b59b6'];
...
var Game = {
    ...
    draw: function () {
        ...
        // Draw the Ball use this ()
this.context.fillText("🥚", this.ball.x, this.ball.y);

// Draw the Ball using the appropriate emoji based on the level
if (Pong._turnDelayIsOver.call(this)) {
    switch (Pong.round) {
        ...
        case 4:
            ...
            break;
        default:
            this.context.fillText("🥚", this.ball.x, this.ball.y); // Default to the chicken emoji
    }
}
